...
# Define the modified scalarized objective function
...
for run in range(num_runs):
    ...
    for _ in range(num_iterations):
        ...
        for i in range(num_items):
            ...
            neighbor_value = scalarized_objective(neighbor)
...
print(f"\nPercentage of Pareto Optimal Solutions: {percentage_pareto_optimal:.2f}%")
